...
<head>
    ...
    <title>Shop by Price Range - YanKicks</title>
...
<body>
    ...
    <main class="shop-page">
        <div class="container">
            <div class="shop-header">
                <h1>Shop by Price Range</h1>
                <p>Find products within your budget</p>
            </div>
    ...
    <script>
        let allProducts = []; // Global storage
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            if (priceFilter) {
                priceFilter.addEventListener('change', (e) => {
                    ...
                    let sortedProducts = [...allProducts]; // Copy array
                    ...
                    if (sortType === 'low-high') {
                        ...
                        // Default: maybe sort by ID or just use original order
