...
<head>
    ...
    <title>Brand Highlights - YanKicks</title>
    ...
    <main class="about-page">
        <div class="container">
            <div class="page-header">
                <h1>Brand Highlights</h1>
                <p>Discover the brands that make YanKicks special</p>
            </div>

            <div class="about-content">
                <div class="about-section">
                    <h2>Our Featured Brands</h2>
                    <p>At YanKicks, we partner with the most innovative and trusted brands in athletic footwear. Each brand brings unique technology, design philosophy, and commitment to excellence that aligns with our mission to provide premium athletic footwear.</p>
                </div>

                <div class="values-list">
                    <div class="value">
                        <h3>Performance Brands</h3>
                        <p>Leading brands focused on athletic performance and innovation</p>
                    </div>
                    <div class="value">
                        <h3>Lifestyle Brands</h3>
                        <p>Trendsetting brands that combine style with comfort</p>
                    </div>
                    <div class="value">
                        <h3>Sustainable Brands</h3>
                        <p>Eco-conscious brands committed to environmental responsibility</p>
                    </div>
                </div>
            </div>
        </div>
