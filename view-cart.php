...
<head>
    ...
    <title>View Cart - YanKicks</title>
    ...
    <main class="shop-page">
        <div class="container">
            ...
            <div style="text-align: center; margin-top: 40px;">
                ...
                <p style="margin-bottom: 20px; font-size: 0.9em; color: #666;">Step 1: Review Cart &rarr; Step 2: Checkout Info &rarr; Step 3: Payment</p>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            if (savedCart) {
                ...
                if(cart.length === 0) {
                    document.getElementById('productsGrid').innerHTML = '<p style="text-align:center; width:100%;">Your cart is empty.</p>';
                    return;
                }

                // Note: displayProducts generally renders a grid. 
                // Ideally, a cart page should use a table layout, but we are using 
                // the existing displayProducts function to keep it simple for now.
                displayProducts(cart.map(item => ({
                    id: item.id,
                    name: item.name,
