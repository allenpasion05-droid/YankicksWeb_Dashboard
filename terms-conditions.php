...
<head>
    ...
    <title>Terms & Conditions - YanKicks</title>
        ...
        <div class="container">
            ...
            <div class="about-content">
                <div class="about-section">
                    ...
                    <p>By accessing or using the YanKicks website, you agree to be bound by these Terms and Conditions and our Privacy Policy. If you do not agree with any part of these terms, you must not use our website.</p>
                </div>

                <div class="about-section">
                    <h2>2. Products and Orders</h2>
                    <p><strong>Product Descriptions:</strong> We strive to display the colors and images of our products accurately. However, we cannot guarantee that your computer monitor's display of any color will be accurate.</p>
                    <p><strong>Order Acceptance:</strong> We reserve the right to refuse or cancel any order for any reason, including but not limited to product availability, errors in the description or price of the product, or error in your order.</p>
                </div>

                <div class="about-section">
                    <h2>3. Pricing and Payments</h2>
                    <p>All prices are subject to change without notice. We accept major credit cards, PayPal, and other payment methods as indicated at checkout. You represent and warrant that you have the legal right to use any payment method utilized in connection with any transaction.</p>
                </div>

                <div class="about-section">
                    <h2>4. Shipping and Returns</h2>
                    <p>Shipping times and costs are specified in our Shipping Policy. Our Return Policy governs the return of products. Please review these policies before making a purchase.</p>
                </div>
                ...
                <div class="about-section">
                    ...
                    <p>In no event shall YanKicks, nor its directors, employees, partners, agents, suppliers, or affiliates, be liable for any indirect, incidental, special, consequential, or punitive damages, including without limitation, loss of profits, data, use, goodwill, or other intangible losses.</p>
                </div>
