...
<head>
    ...
    <title>Shop by Brand - YanKicks</title>
    ...
    <main class="shop-page">
        <div class="container">
            <div class="shop-header">
                <h1>Shop by Brand</h1>
                <p>Browse our products sorted by brand</p>
            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            fetch('api/products.php')
                ...
                .then(data => {
                    // Sort data alphabetically by name to group brands together
                    // (Assuming names are like "Nike Air", "Adidas Ultra", etc.)
