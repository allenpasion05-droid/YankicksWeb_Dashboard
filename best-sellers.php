...
<head>
    ...
    <title>Best Sellers - YanKicks</title>
    ...
    <main class="shop-page">
        <div class="container">
            ...
            <div class="products-grid" id="productsGrid">
                <p style="text-align:center; width:100%;">Loading best sellers...</p>
            </div>
        </div>
    </main>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            fetch('api/products.php')
                ...
                .then(data => {
                    ...
                    // Note: 'p.rating' might be a string from DB, so we use == 5 (loose equality) or parseInt
                    const bestSellers = data.filter(p => p.rating == 5);
                    
                    if (bestSellers.length > 0) {
                        displayProducts(bestSellers);
                    } else {
                        document.getElementById('productsGrid').innerHTML = '<p>No best sellers found yet.</p>';
                    }
                })
                .catch(err => {
